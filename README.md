...
The DOM is the document object model. It represents the window and all of the content inside of it. Essentially the webpage we see.


2. What is an event?

Events are actions that take place on a website such as scroll, click, etc. Events trigger side-effects.

3. What is an event listener?

An event listener is used to execute a function on the specific event that takes place. The event listener waits for that event to happen and then executes the function.

4. Why would we convert a NodeList into an Array?

Converting the NodeList to an array makes it easier to traverse the NodeList and manipulate the dom.

5. What is a component?

Components are reusable pieces of code that can be used as needed throughout a project.